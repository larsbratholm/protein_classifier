...
Example model and trainer parameters can be seen in e.g. [data/final](./data/final/).
...
```
Example checkpoint can be found in e.g. [data/final/split\_0/swa\_last.ckpt](./data/final/split_0/swa_last.ckpt).
